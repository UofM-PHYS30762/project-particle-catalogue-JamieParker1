...
Muon::Muon(std::unique_ptr<FourMomentum> four_momentum, bool is_isolated, int lepton_number)
    : Lepton("muon", -1, 105.7, std::move(four_momentum), lepton_number), is_isolated(is_isolated) {} // Muons have a charge of -1
...
Muon::Muon(const std::string &label, std::unique_ptr<FourMomentum> four_momentum, bool is_isolated, int lepton_number)
    : Lepton("muon", label, -1, 105.7, std::move(four_momentum), lepton_number), is_isolated(is_isolated) {} // Muons have a charge of -1
